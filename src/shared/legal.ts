...
export const WEBSITE_FEATURES = [
  { name: 'Casino Catalog', path: '/casinos', desc: 'Search, filter, and browse verified sweepstakes casinos' },
  { name: 'Similar Casinos', path: '/similar', desc: 'Match by features — search the free web for casinos like any operator' },
  { name: 'URL Checker', path: '/tools/checker', desc: 'Check links against the blocklist and verified catalog' },
